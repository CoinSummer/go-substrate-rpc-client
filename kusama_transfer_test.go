...
func TestKusamaTransfer(t *testing.T)  {
	...
	// kkk1
	bob, err := types.NewMultiAddressFromHexAccountID("0x40cf5ea3136c50ad55b91b8fd73cdcdb925152ba38e21586d4a943373eb5d25a")
	if err != nil {
		panic(err)
	}

	// 1 unit of transfer
	bal, ok := new(big.Int).SetString("100000000", 12)
	if !ok {
